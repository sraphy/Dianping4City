...
if (small_areas){
  data_raw <- read.csv("~/Downloads/2014-01-SOM-Example-code_release/census_data/AllThemesTablesSA.csv")  
  ireland_map <- readShapePoly('~/Downloads/2014-01-SOM-Example-code_release/boundary_files/Census2011_Small_Areas_generalised20m.shp')
...
source("~/Downloads/2014-01-SOM-Example-code_release/convertCSOdata.R")
